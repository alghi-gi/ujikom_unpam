<?php 
  ...
  $sql_panggil_anggota = mysqli_query($konek, "SELECT * FROM tb_anggota");
...
<head>
  ...
  <div class="container">
    <h4 class="mt-3"><i class="fas fa-table"></i> Data Anggota</h4>
    <br>
    <div class="container rounded-lg shadow p-3 mb-3 bg-white rounded">
      <div class="row">
        <div class="col">
          <a href="tambah_data_anggota.php" class="btn btn-primary">+</a>
        </div>
      </div>
      <div class="table-responsive mt-3">
        <table class="table table-bordered table-striped text-dark">
          ...
          <tbody>
            <?php $no=1 ?>
            <?php foreach ($sql_panggil_anggota as $data): ?>
              <tr>
                <td><?php echo $no++; ?>.</td>
                <td><?php echo $data['nim']; ?></td>
                <td><?php echo $data['nm_ang']; ?></td>
                <td><?php echo $data['jk_ang']; ?></td>
                <td><?php echo $data['usia']; ?></td>
                <td><?php echo $data['semester_ang']; ?></td>
                <td><?php echo $data['kelas_ang']; ?></td>
                <td><?php echo $data['nomer_ang']; ?></td>
                <td><?php echo $data['alamat_ang']; ?></td>
                <td>
                  <a onclick="return confirm('apakah data ini ingin dihapus?')" href="hapus_anggota.php?id_ang=<?php echo $data['id_ang']; ?>" class="btn btn-danger">Hapus</a>
                  <a href="ubah_anggota.php?id_ang=<?php echo $data['id_ang']; ?>" class="btn btn-warning mt-2">Ubah</a>
                </td>
              </tr>
            </tbody>
          <?php endforeach ?>
